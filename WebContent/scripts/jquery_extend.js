...
p_verify["phone"] = function(o) {// 手机验证
	var v = p_verify.val(o);
	var pattern = /^1[34578]\d{9}$/;
	if(! pattern.test(v)){
		p_verify.msg(o, "请输入正确的手机号码");
	} else {
		o.attr("v_check", "Y");
	}
	return p_verify["verify"](o);
}
p_verify["noNull"] = function(o) {// 非空验证
...
p_verify["number"] = function(o) {// 数字验证
	var v = p_verify.val(o);
	if (isNaN(v)) {
		o.attr("v_check", "Y");
	} else {
