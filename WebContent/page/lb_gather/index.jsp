...
<body class="body">
  ...
  <a class="layui-btn  layui-btn-xs" lay-role="g_upd" lay-event="upd">编辑</a>
  <a class="layui-btn  layui-btn-xs" lay-role="g_acust" lay-event="acust">添加客户</a>
  <a class="layui-btn  layui-btn-xs" lay-role="g_follow" lay-event="follow">跟进</a>
<a class="layui-btn  layui-btn-xs" lay-role="g_move" lay-event="move">移交</a>
  <a class="layui-btn layui-btn-xs" lay-role="g_del" lay-event="del">删除</a>
	...
	<div class="demoTable">
		...
		<button class="layui-btn" id="add" lay-role="g_add">新增</button>
